...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label_phone = tk.Label(self, text = "Phone Number", font = controller.normal_font)
        ...
        label_lkpremium.grid(row=7, column = 0)

        self.entry_username = tk.Entry(self)
        self.entry_password = tk.Entry(self, show="*")
        self.entry_phone = tk.Entry(self, show = "*")
        ...
        button.grid(row=9, columnspan=2, pady=30)
